...
* Mở dấu ngoặc đơn cho cấu trúc điều khiển PHẢI KHÔNG có một whitespace phía sau, và trước đóng ngoặc đơn cũng vậy.
...
Từ khóa `var` thì KHÔNG PHẢI dùng để khai báo property.

KHÔNG PHẢI được khai báo nhiều hơn một property ở mỗi câu lệnh khai báo.
...
Phía sau tên method KHÔNG PHẢI có space nào cả.
Mở ngoặc nhọn PHẢI nằm ở dòng tiếp theo và đóng ở dòng kết tiếp của nội dung.
KHÔNG PHẢI được có khoảng trống nào ở sau mở ngoặc đơn và ở trước đóng ngoặc đơn cũng vậy.
...
#### 4.4 Method argument
Trong danh sách argument, KHÔNG PHẢI có whitespace trước dấu phẩy, và PHẢI có một whitepsace sau dấu phẩy.
...
Khi gọi method hoặc function, KHÔNG PHẢI có whitespace giữa tên và mở ngoặc đơn, phía sau mở ngoặc đơn và phía trước đóng ngoặc đơn.

Trong danh sách argument thì KHÔNG PHẢI có whitespace phía trước dấu phẩy, và PHẢI có một whitespace phía sau dấu phẩy.
```php
<?php
bar();
$foo->bar($arg1);
...
* KHÔNG PHẢI có whitespace nào trước và sau đóng mở ngoặc đơn
